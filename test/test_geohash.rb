...
class GeoHashTest < MiniTest::Test
  ...
  def test_decoding
    assert_equal [39.02474, -76.51100], GeoHash.center("dqcw4bnrs6s7")
    assert_equal [37.791562, -122.398541], GeoHash.center("9q8yyz8pg3bb", 6)
    assert_equal [37.791562, -122.398541], GeoHash.center("9Q8YYZ8PG3BB", 6)
    assert_equal [42.60498046875, -5.60302734375], GeoHash.center("ezs42", 11)
    assert_equal [-25.382708, -49.265506], GeoHash.center("6gkzwgjzn820",6)
    assert_equal [-25.383, -49.266], GeoHash.center("6gkzwgjz", 3)
    assert_equal [37.8565, -122.2554], GeoHash.center("9q9p658642g7", 4)
  end
  ...
  def check_decoding(gh)
    exact = GeoHash.center(gh, 20)
    bbox = GeoHash.decode(gh)
  ...
  def test_specific_bbox
    assert_equal [[39.0234375, -76.552734375], [39.0673828125, -76.5087890625]], GeoHash.decode('dqcw4')
  end
  
  def test_neighbors
    assert_equal ["dqcjr1", "dqcjq9", "dqcjqf", "dqcjqb", "dqcjr4", "dqcjr0", "dqcjqd", "dqcjq8"], GeoHash.neighbors("dqcjqc")
    ...
    assert_equal 8, (["dqcw7", "dqctg", "dqcw4", "dqcwh", "dqcw6", "dqcwk", "dqctf", "dqctu"] & GeoHash.neighbors("dqcw5")).size
  end
